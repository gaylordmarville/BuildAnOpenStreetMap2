...
void RoutePlanner::AStarSearch() {
    ...
    // std::cout<<"current_node->neighbors "<<current_node->start_node->x<<"\n";
    // std::cout<<"current_node->neighbors "<<current_node->start_node->x<<"\n";
    ...
    // for(auto neighbors : current_node->neighbors) {
    //     std::cout<<"neighbors->g_value "<<neighbors->g_value<<"\n";
    //     std::cout<<"neighbors->h_value "<<neighbors->h_value<<"\n";
    //     std::cout<<"neighbors->x "<<neighbors->x<<"\n";
    //     std::cout<<"neighbors->y "<<neighbors->y<<"\n";
    // }
    ...
    std::vector<RouteModel::Node> final_path = this->ConstructFinalPath(next_node);
